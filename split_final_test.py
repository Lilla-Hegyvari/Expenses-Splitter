...
def split_expenses(expenses, start_date=None, end_date=None):
    ...
    Args:
        expenses (str): Path to the Excel file containing the expense data.
        start_date (str or datetime-like, optional): The start date for filtering (inclusive).
        end_date (str or datetime-like, optional): The end date for filtering (inclusive).

    Returns:
        dict: A dictionary mapping each person to their net balance. 
